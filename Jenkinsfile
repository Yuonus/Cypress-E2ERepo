pipeline {
    ...
    parameters{
        string(name: 'SPEC', defaultValue: "cypress/e2e/tests/**/**", description: "Enter the script path that you would like to execute")
    ...
    post{
        always{
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'cypress/report', 
